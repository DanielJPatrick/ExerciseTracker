        ...
        public AttributeViewHolder(View itemView) {
            ...
            this.deleteIv.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    RealmResults<DAttribute> realmResults = Realm.getDefaultInstance().where(DAttribute.class).findAll();
                    AttributeAdapter.this.setItems(realmResults.toArray(new DAttribute[realmResults.size()]));
                }
            });
        }
